  ...
  resolve(
    ...
    return this.personService.get(this.authData.personId, {}).then(payloadp => {
      ...
      if (auth == null || auth === undefined) {
        ...
        auth.corporateOrganisationId == null ||
        auth.corporateOrganisationId === undefined
      ) {
        ...
        return this.corporateFacilityService
          .get(auth.corporateOrganisationId, {})
          .then(single => {
