...
@Component({
  ...
  templateUrl: './new-opd-entry.component.html',
  styleUrls: ['./new-opd-entry.component.scss', '../../daily-antenatal/new-antenatal-entry/new-antenatal-entry.component.scss']
})
export class NewOpdEntryComponent implements OnInit {
