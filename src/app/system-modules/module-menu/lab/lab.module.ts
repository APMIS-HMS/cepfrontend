...
@NgModule({
  ...
  declarations: [LabRequestsComponent, LabComponent, WorkbenchComponent, RequestDetailComponent, InvestigationServiceComponent, InvestigationPriceComponent, PanelComponent]
})
