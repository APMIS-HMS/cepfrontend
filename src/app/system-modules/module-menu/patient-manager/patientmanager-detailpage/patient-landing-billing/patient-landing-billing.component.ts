...
import {
  FacilitiesService, InvoiceService, BillingService, PersonService, PatientService, PendingBillService,
  TodayInvoiceService
} from '../../../../../services/facility-manager/setup/index';
import { User, Facility, BillModel, Invoice, Patient } from '../../../../../models';
@Component({
  selector: 'app-patient-landing-billing',
  templateUrl: './patient-landing-billing.component.html',
  styleUrls: ['./patient-landing-billing.component.scss', '../../../payment/bill-lookup/bill-lookup.component.scss']
})
export class PatientLandingBillingComponent implements OnInit {
  ...
  private _getAllInvoices() {
    ...
    this.invoiceService.find({
      query: {
        facilityId: this.selectedFacility._id, balance: { $gt: 0 },
