          ...
          .then(
            payload => {
              ...
              if (payload.status === "success") {
                this.duplicate = true;
                this.errMsg =
                  "Duplicate record detected, please check and try again!";
                this.mainErr = false;
              } else {
    ...
    if (valid) {
      ...
      const personModel = <any>{
        title: this.titleCasePipe.transform(
          this.frmPerson.controls["persontitle"].value
        ),
        firstName: this.titleCasePipe.transform(
          this.frmPerson.controls["firstname"].value
        ),
        lastName: this.titleCasePipe.transform(
        ...
        motherMaidenName: this.titleCasePipe.transform(
          this.frmPerson.controls["motherMaidenName"].value
        ),
        ...
        securityAnswer: this.titleCasePipe.transform(
          this.frmPerson.controls["securityAnswer"].value
        )
      };
      let body = {
        person: personModel
