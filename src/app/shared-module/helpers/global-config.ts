...
export const DosageUnits = [
  {id: 1, name: 'mL', selected: true}, {id: 2, name: 'mg', selected: false},
  {id: 3, name: 'g', selected: false}, {id: 4, name: 'g/mL', selected: false},
  {id: 5, name: 'L', selected: false}, {id: 6, name: 'cm', selected: false}
];
...
export const Genotypes = [
  {id: 1, name: 'N/A', selected: true}, {id: 1, name: 'AA', selected: false},
  {id: 2, name: 'AS', selected: false}, {id: 3, name: 'AC', selected: false},
  {id: 4, name: 'SS', selected: false}, {id: 5, name: 'SC', selected: false},
...
export const PAYSTACK_CLIENT_KEY =
    'pk_test_3c53bcffeb3c889d04ea0f905c44d36fc342aa85';
...
export const HTML_SAVE_PATIENT =
